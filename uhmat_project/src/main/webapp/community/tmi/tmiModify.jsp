	...
	<!-- tmi 게시글 수정 -->
     <section class="page-section" id="contact">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">TMI 글 수정</h2>
                <!-- Icon Divider-->
				...
				<form action="TmiModifyPro.co" name="tmiBoardForm" method="post">
					...
					<div class="form-floating mb-3">	
							<input type="text" class="form-control" name="subject" id="subject" value="${tmiBoard.subject }" required="required" >
