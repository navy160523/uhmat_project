	...
	<!-- 헤더 들어가는 곳 -->
 		<section class="page-section" id="contact">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">notice 글 쓰기</h2>
                <!-- Icon Divider-->
		...
		<form action="NoticeWritePro.sc" method="post" enctype="multipart/form-data" name="boardform">
				...
				<div class="form-floating mb-3">
 				 ...
 				 <div class="form-floating mb-3">
				    <input class="form-control form-control-sm" type="file" name="file" id="file" placeholder="제목을 입력해주세요!" required="required" >
