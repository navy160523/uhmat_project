...
import svc.main.MaimFormService;
...
public class MainFormAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		MaimFormService service = new MaimFormService();
		...
		reviewBestLikeList = service.getBestLikeBoardList(pageNum,listLimit);
		...
		// 최다 좋아요 리뷰 리턴
		request.setAttribute("reviewBestLikeList", reviewBestLikeList);
