...
public class MemberTmiListService extends TmiListService {
	public int getTmiListCount(String keyword,String nickName) {
	...
	public ArrayList<CommunityTmiDTO> getTmiBoardList(int pageNum, int listLimit, String keyword,String nickName) {
		System.out.println("---------------------------------------------");
